...
namespace WebBanGauBong.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult TimKiemSanPham(string name)
        {
            return View("Index", csdl.Product.ToList().FindAll(sp => sp.ProductName.ToLower().Trim().Contains(name.ToLower().Trim())));
        }
        ...
        {
            return PartialView(csdl.Category);
        }

        public ActionResult TrangLoaiSanPham()
        {
            return View();
        }
